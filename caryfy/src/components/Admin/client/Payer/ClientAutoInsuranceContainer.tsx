...
const ClientAutoInsuranceContainer: FunctionComponent = () => {
  ...
  return (
    ...
    >
      <div id="cts-width-full"  className="self-stretch flex flex-row flex-wrap items-start justify-start py-0 pr-1.5 pl-0 gap-[16px_14.7px]">
        <InputsNew label={"Auto Insurance ID*"} contentPlaceholder={""} type={"text"} />
        <InputsNew label={"Alternate Auto Insurance ID"} contentPlaceholder={""} type={"text"} />
      ...
      <div id="cts-width-full"  className="self-stretch flex flex-row flex-wrap items-start justify-start py-0 pr-[264px] pl-0 box-border gap-[16px] max-w-full mq450:pr-5 mq450:box-border mq950:pr-[66px] mq950:box-border mq1425:pr-[132px] mq1425:box-border">
        ...
        <InputsNew label={"Authorization End Date"} contentPlaceholder={""} type={"datetime-local"} />
      </div>
      ...
      <div id="btn-cts-row" className="self-stretch flex flex-row items-center justify-end nowrap py-0 pr-0 pl-[984px] gap-[8px] mq450:pl-5 mq450:box-border mq950:pl-[246px] mq950:box-border mq1425:flex-wrap mq1425:pl-[492px] mq1425:box-border">
...
export default ClientAutoInsuranceContainer;
