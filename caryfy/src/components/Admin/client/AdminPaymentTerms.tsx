...
const columns: (keyof DataRow)[] = ['Call Type', 'Shift Type', 'Bill Rate', 'Effective Date',];
const data: DataRow[] = [
  { 'Call Type': 'SFC ($99.72), SFC ($99.72)', 'Shift Type': 'Weekly', 'Bill Rate': '$39.95', 'Effective Date': '04-12-2021', }
];

const AdminPaymentTerms: FunctionComponent = () => {
  ...
  return (
    ...
    >
      <div className="self-stretch flex flex-row items-center justify-start gap-[5px] max-w-full mq1425:flex-wrap">
        ...
        <button id="reset-cts-dv" className="cursor-pointer [border:none] py-spacing-spacing-xs px-spacing-spacing-sm bg-surface-primary-surface rounded-radius-radius-sm flex flex-row items-center justify-center gap-[4px]">
      ...
      <div id="inner-admin-paymets" className="self-stretch rounded-radius-radius-lg bg-surface-bg-blue flex flex-col items-start justify-start p-8 gap-[24px] text-sm">
