...
const AdminAddPaymentTerm: FunctionComponent = () => {
    ...
    return (
        <div id="cts-interaction-blg"
            className="self-stretch rounded-radius-radius-lg bg-surface-bg-blue flex flex-col items-start justify-start box-border gap-[24px] max-w-full text-left text-sm text-colors-text-black font-body-xs-semi-bold mq450:pt-[21px] mq450:pb-[21px] mq450:box-border">
            <div className="self-stretch flex flex-col items-start justify-start gap-[8px] max-w-full">
                ...
                <div className="self-stretch flex flex-row flex-wrap items-center justify-start py-0 pr-[59px] pl-0 box-border gap-[8px_16px] min-h-[73px] mq1425:pr-[29px] mq1425:box-border">
                    <div className={`flex flex-row items-center justify-start gap-[6px] ${checkedItems['SFC'] ? 'text-blue-500' : 'text-black'}`}>
                        <input
                    ...
                    <div className={`flex flex-row items-center justify-start gap-[6px] ${checkedItems['SOURCE'] ? 'text-blue-500' : 'text-black'}`}>
                        <input
                            className="m-0 h-4 w-4 relative overflow-hidden shrink-0"
                            type="checkbox"
                            name="SOURCE"
                    ...
                    <div className={`flex flex-row items-center justify-start gap-[6px] ${checkedItems['Assessor_Visit'] ? 'text-blue-500' : 'text-black'}`}>
                        <input
                            className="m-0 h-4 w-4 relative overflow-hidden shrink-0"
                            type="checkbox"
                            name="Assessor_Visit"
                    ...
                    <div className={`flex flex-row items-center justify-start gap-[6px] ${checkedItems['Call_Test'] ? 'text-blue-500' : 'text-black'}`}>
                        <input
                            className="m-0 h-4 w-4 relative overflow-hidden shrink-0"
                            type="checkbox"
                            name="Call_Test"
                    ...
                    <div className={`flex flex-row items-center justify-start gap-[6px] ${checkedItems['Client_Billing'] ? 'text-blue-500' : 'text-black'}`}>
                    ...
                    <div className={`flex flex-row items-center justify-start gap-[6px] ${checkedItems['Community_Shift'] ? 'text-blue-500' : 'text-black'}`}>
                ...
                <div   id="addshift-date-time-dv"  className="w-full flex flex-col items-start justify-start gap-[8px] min-w-[191px] max-w-[322px] mt-5">
                    <InputsNew label="Make Effective Date From" contentPlaceholder="05-17-2021" type="datetime-local" />
                </div>
                <div className="self-stretch flex flex-row items-center justify-start gap-[8px] max-w-full text-surface-primary-surface mq1425:flex-wrap mt-3">
                    ...
                    <div id="cts-full-width" className="flex-1 flex flex-row flex-wrap items-center justify-start min-w-[322px] max-w-full text-colors-text-black ml-8">
                        ...
                        <div className="self-stretch shadow-[0px_1px_2px_rgba(16,_24,_40,_0.05)] rounded-radius-md bg-surface-bg-primary overflow-hidden flex flex-row items-center justify-start py-2.5 px-[15px] border-[1px] border-solid border-surface-border">
                            ...
                            <InputsNew label="Bill Rate" contentPlaceholder="Bill Rate" type="text" />

                        </div>
                    </div>
                </div>
                <div className="self-stretch flex flex-row items-center justify-end py-0 pr-0 pl-[984px] gap-[8px] mq450:pl-5 mq450:box-border mq950:pl-[246px] mq950:box-border mq1425:flex-wrap mq1425:pl-[492px] mq950:pb-5 mq1425:box-border">
...
export default AdminAddPaymentTerm;
