...
const AssessorDetailScreen: FunctionComponent = () => {
    ...
    function handleClick() {
        history.push('/admin_employee_personal_info');
    };
    ...
    return (
        ...
        >
            <div className="self-stretch flex flex-row items-center justify-start gap-[5px] max-w-full">
                ...
                />
                <h2 className="m-0 flex-1 relative text-inherit font-bold font-inherit inline-block max-w-[calc(100%_-_29px)] mq450:text-base">{`Assessor Details `}</h2>
            </div>
            <div className="self-stretch rounded-radius-radius-lg bg-surface-bg-blue flex flex-col items-start justify-start p-8 box-border max-w-full text-center text-sm">
                <div id="assessor_upload_blg" className="self-stretch flex flex-row flex-wrap items-center justify-start py-0 pr-0.5 pl-0 box-border gap-[24px_22px] max-w-full">
                    <div id="cts-assesor-detail" className="flex-1 rounded bg-surface-bg-blue flex flex-col items-center justify-center p-2.5 box-border min-w-[335px] max-w-full">
...
export default AssessorDetailScreen;
