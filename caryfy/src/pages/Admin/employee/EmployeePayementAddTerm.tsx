...
import EmployeeAddPaymentTerm from "../../../components/Admin/employee/EmployeeAddPaymentTerm";

const EmployeePayementAddTerm: FunctionComponent = () => {
  return (
    <div className="w-full relative bg-surface-bg-primary overflow-hidden flex flex-col items-start justify-start min-w-[360px] max-w-[1920px] leading-[normal] tracking-[normal] mq450:max-w-full mq950:max-w-full mq1425:max-w-full mq1900:max-w-full">
      <section id="cts-respon-p-dv" className="self-stretch overflow-hidden flex flex-row flex-wrap items-start justify-center themebg-cts-blg min-h-screen py-40 px-5 box-border max-w-full z-[1] text-left text-xl text-colors-text-black font-body-xs-semi-bold mq950:pt-[52px] mq950:pb-[52px] mq950:box-border">
...
export default EmployeePayementAddTerm;
