...
import ClientPrivatePayContainer from "../../../../components/Admin/client/Payer/ClientPrivatePayContainer";

const ClientPrivatePayPage: FunctionComponent = () => {
  return (
    <div className="w-full relative bg-surface-bg-primary overflow-hidden flex flex-col items-start justify-start min-w-[360px] max-w-[1920px] leading-[normal] tracking-[normal] mq450:max-w-full mq950:max-w-full mq1425:max-w-full mq1900:max-w-full">
      <img
        className="w-[3265px] h-[3394px] absolute !m-[0] bottom-[-1715px] left-[-745px]"
        alt=""
      />
...
export default ClientPrivatePayPage;
