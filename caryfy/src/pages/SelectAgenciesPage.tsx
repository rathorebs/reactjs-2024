...
import SelectAgencyContainer from "../components/SelectAgencyContainer";

const SelectAgenciesPage: FunctionComponent = () => {
  ...
  return (
    <div className="w-full relative bg-surface-bg-primary overflow-hidden flex flex-col items-start justify-start min-w-[360px] max-w-[1920px] tracking-[normal] leading-[normal] text-left text-xl text-colors-text-black font-body-xs-semi-bold mq450:max-w-full mq950:max-w-full mq1425:max-w-full mq1900:max-w-full">
      ...
      <div
        id="cts-respon-p-dv"
        className="themebg-cts-blg self-stretch overflow-hidden flex flex-row flex-wrap min-h-screen items-start justify-center py-40 px-5 box-border max-w-full z-[1] mq950:pt-[34px] mq950:pb-[34px] mq950:box-border mq1425:pt-[52px] mq1425:pb-[52px] mq1425:box-border"
      >
...
export default SelectAgenciesPage;
