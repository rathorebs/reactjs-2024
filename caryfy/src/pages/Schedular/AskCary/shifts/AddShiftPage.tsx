...
import AddShift from "../../../../components/Schedular/AskCary/shifts/AddShift";
...
const AddShiftPage: FunctionComponent = () => {
  ...
  return (
    <div id="cts-respon-p-dv" className="self-stretch bg-gray overflow-hidden flex flex-col py-40 items-center justify-start relative gap-[24px] min-h-[screen] max-w-full">
      <img
